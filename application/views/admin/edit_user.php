											...
											<div class="form-body">
												...
												<div class="form-group"> 
													...
													* </span>
													...
													<div class="col-md-10">
														 <input type="text"  class="form-control" name="nama_user" value="<?php echo $u[0]->nama_user; ?>">
													</div>
												</div>
												<div class="form-group">
												...
												<div class="form-group">
													...
													* </span>
													...
													<div class="col-md-10">
														<input type="text" class="form-control" name="username"  value="<?php echo $u[0]->username; ?>"> 
													</div>
												</div>
												<div class="form-group">
