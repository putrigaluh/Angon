						...
						<div class="portlet-body">
							<div class="table-container">
								...
								<tr role="row" class="filter">
									...
									<td>
										<input type="text" class="form-control form-filter input-sm" name="id_user">
									</td>
									<td>
										<select name="kategori_user" class="form-control form-filter input-sm">
											<option value="">Select...</option>
											<option value="1">Peternak</option>
											<option value="2">Industri Ternak</option>
											<option value="3">Pengguna Hasil Ternak</option>
											
										</select>
									</td>
									<td>
										<input type="text" class="form-control form-filter input-sm" name="nama_user">
										
									</td>
									<td>
										<div class="margin-bottom-5">
											<input type="text" class="form-control form-filter input-sm" name="" placeholder=""/>
										</div>
									</td>
									<td>
										<div class="margin-bottom-5">
								...
								<tbody>
									...
									<td>
										<div class="margin-bottom-5">
											<?php print "<a href=" . $this->config->base_url() . 'admin/user/edit/' . $user->id_user . ">Edit</a>" ?> 

										</div>
										<div class="margin-bottom-5">
											<?php print "<a href=" . $this->config->base_url() . 'admin/user/delete/' . $user->id_user . ">Delete</a>" ?>
										</div>
									</td>
								</tr>
								<?php } ?>
